...
| Ideas y pendientes sueltos que vas capturando (append-only) | `progress/backlog.md` |
...
archivos como pasaba antes. El ritual `/cerrar` destila lo terminado y rota lo pesado a `archive/`, así
ningún archivo crece sin fin.

## Modelo de trabajo diario (queda listo en la instalación)

La Etapa 1 también instala tu **modo de trabajo**: el archivo de ideas (`backlog.md`), las reglas de
retención, y un set de **comandos `/`** en `.claude/commands/` que son tu rutina hecha botones —
